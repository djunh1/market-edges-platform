...
SECRET_KEY = "django-insecure-hzt#v@-15qe&^!53_*m932uc&qud2g^ct$#ka$ggkqad9y-%&i"
...
ROOT_URLCONF = "marketedgeplatorm.urls"
...
WSGI_APPLICATION = "marketedgeplatorm.wsgi.application"
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # for prod/s3
